...
import com.sentraboga.buybay.dialog.setupBottomSheetDialog
import com.sentraboga.buybay.util.Resource
import com.sentraboga.buybay.viewmodel.LoginViewModel
...
class LoginFragment: Fragment(R.layout.fragment_login) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvForgotPassLogin.setOnClickListener {
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.resetPass.collect{
                when(it){
                    ...
                    is Resource.Success -> {
                        Snackbar.make(requireView(), "Periksa link verifikasi yang dikirimkan ke email!", Snackbar.LENGTH_LONG).show()
                    }
                    is Resource.Error -> {
